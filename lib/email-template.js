...
export function pieDeBaja({ html, plainText, brand, urlBaja }) {
  const pie = `
  <div style="max-width:600px;margin:0 auto;padding:22px 24px 34px;font-family:Arial,Helvetica,sans-serif;color:#9aa1ab;font-size:12px;line-height:1.6;text-align:center">
