  ...
  return `<table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background:${kit.panel};border-radius:14px;overflow:hidden;">
    ...
    <tr>
      <td style="padding:14px 14px 18px 14px;text-align:center;">
        ...
        <a href="${url}" style="display:inline-block;margin-top:12px;font-family:${kit.fuenteCuerpo};font-size:13px;font-weight:600;color:${kit.color};text-decoration:none;border:1.5px solid ${kit.color};border-radius:999px;padding:8px 20px;">Comprar</a>
      </td>
    </tr>
  </table>`;
}
